...
rom unsigned char rCO_DevIdentityIndx = 	0x4;
rom unsigned long rCO_DevVendorID = 		0x44441111L;
rom unsigned long rCO_DevProductCode = 		0x44443333L;
rom unsigned long rCO_DevRevNo = 		0x44444444L;
rom unsigned long rCO_DevSerialNo = 		0x44445555L;
